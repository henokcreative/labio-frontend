...
const AboutPage = () => {
  ...
  return (
    <div className="about-page">
      ...
      />
      <section>
        <h3 className="gradient-text mb-4">Bridging Science and Storytelling</h3>
        <p className="lead">
      ...
      <section >
        <p className="blockquote my-4">The Unsung Role of Multimedia in Modern Science Communication</p>
        <p>
