  ...
  return (
         <div id="cv" className="instaFade resume-page">
            <div className="mainDetails">
                <div id="headshot">
                    <img src="assets/img/photos/Henok_K.jpeg" alt="Henok Karvonen" />
                </div>
            ...
            <div id="mainArea">
                ...
                <section>
                    ...
                    <div className="sectionContent">
                        <article>
                            <h2>Multimedia producer, University of Turku, Finland</h2>
                        ...
                        <article>
                            <h2>Master’s thesis project researcher, University of Turku, Finland</h2>
                        ...
                        <article>
                            <h2>Primary school teacher, Addis Ababa, Ethiopia</h2>
                ...
                <section>
                    ...
                    <div className="sectionContent">
                        ...
                        <article>
                            <h2>Kotebe Metropolitan University</h2>
